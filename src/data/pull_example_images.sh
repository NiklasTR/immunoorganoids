...
# Bortezomib
cp --parents PROMISE-4x-1t-1z-Brightfield-fast_HC9000E001D080B001*/C_21_wv_TL_Brightfield_dsRed.tif ../../../../../data/interim/automatic_microscopy/HC9000E001
cd $WD
...
# Bortezomib
cp --parents PROMISE-20x-6t-c-5z_IO_HC9000E001D080B001*/C_21_fld_5* ../../../../../data/interim/automatic_microscopy/HC9000E001
cd $WD  
echo copy completed